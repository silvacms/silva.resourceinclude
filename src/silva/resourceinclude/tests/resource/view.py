"""
   ...
   ['silva.resourceinclude.tests.resource.static']
   >>> resource_css_view.get_relative_path()
   ['silva.resourceinclude.tests.resource.static', 'style.css']
   >>> resource_image_view.get_relative_path()
   ['silva.resourceinclude.tests.resource.static', 'images', 'img01.gif']

   And so you can the URL of the resource:
   >>> resources_view()
   u'http://localhost/root/++resource++silva.resourceinclude.tests.resource.static'
   >>> resource_css_view()
   u'http://localhost/root/++resource++silva.resourceinclude.tests.resource.static/style.css'
  >>> resource_image_view()
  u'http://localhost/root/++resource++silva.resourceinclude.tests.resource.static/images/img01.gif'
